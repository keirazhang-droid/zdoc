...
You can use the Zilliz Cloud Terraform Provider to create a BYOC or BYOC-I project and deploy related data plane resources within your VPC. For details, refer to the following tutorials:
