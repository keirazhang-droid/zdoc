...
beta: FALSE
notebook: FALSE
description: "This article demonstrates how to count entities in a collection and explains why the entity count might differ from the actual figure. | BYOC"
type: origin
