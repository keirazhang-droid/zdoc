...
beta: PRIVATE
notebook: FALSE
description: "StructArray operators filter entities by evaluating predicates on scalar subfields inside a StructArray field. Use this page as a syntax reference for `elementfilter` and the `MATCH` operator family. | BYOC"
type: origin
