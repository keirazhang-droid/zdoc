...
beta: FALSE
notebook: FALSE
description: "Loading a collection is a prerequisite for conducting similarity searches and queries within it. This page focuses on the procedures for loading and releasing a collection. | Cloud"
type: origin
