...
beta: FALSE
notebook: FALSE
description: "Every collection in Zilliz Cloud must have a primary field to uniquely identify each entity. This field ensures that every entity can be inserted, updated, queried, or deleted without ambiguity. | Cloud"
type: origin
