...
beta: FALSE
notebook: FALSE
description: "An ARRAY field stores an ordered list of elements of the same data type. | Cloud"
type: origin
...
An ARRAY field stores an ordered list of elements of the same data type. 
