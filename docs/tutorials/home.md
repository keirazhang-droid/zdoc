...
- [Serverless](./create-cluster)

- [Dedicated](./create-cluster)
...
1. Create and connect to your cluster.
    ...
    [Create a cluster](./create-cluster) with your desired compute and storage resources and then [connect](./quick-start) to it.
...
1. Create a collection and configure the embedding function.
    ...
    [Create a managed collection](./manage-collections-sdks) with at least one vector field and one VARCHAR field, and define a text embedding [function](./function-and-model-inference).
