---
title: "減衰ランカーの概要 | Cloud"
slug: /decay-ranker-oveview
sidebar_key: decay-ranker-oveview
sidebar_label: "減衰ランカーの概要"
beta: FALSE
notebook: FALSE
description: "従来のベクトル検索では、結果は純粋にベクトル類似度、つまり数学的な空間におけるベクトルの一致度によってランク付けされます。しかし現実のアプリケーションでは、コンテンツの真の関連性は、意味的な類似性だけでは決まらないことがよくあります。 | Cloud"
type: origin
