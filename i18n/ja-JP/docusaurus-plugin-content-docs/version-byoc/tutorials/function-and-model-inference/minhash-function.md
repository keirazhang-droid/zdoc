---
title: "MinHash 関数 | BYOC"
slug: /minhash-function
sidebar_key: minhash-function
sidebar_label: "MinHash 関数"
beta: PRIVATE
notebook: FALSE
description: "MinHash 関数は、生のテキストをバイナリベクトルに変換し、文書間の Jaccard 類似度を近似します。テキストシャングリングと複数のハッシュ関数を適用して固定長のシグネチャベクトルを生成し、大規模な近似重複検出と文書の重複除去を高速に実現します。 | BYOC"
type: origin
