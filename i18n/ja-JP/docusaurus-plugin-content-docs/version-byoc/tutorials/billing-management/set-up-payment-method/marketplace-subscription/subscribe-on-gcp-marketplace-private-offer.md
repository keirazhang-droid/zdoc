---
title: "Google Cloud Marketplace のプライベートオファーを購読する | BYOC"
...
beta: FALSE
notebook: FALSE
description: "Google Cloud Marketplace のプライベートオファーは、Zilliz が組織向けに作成したカスタム購入オプションです。パブリックオファーは Google Cloud Marketplace の製品ページに表示される標準価格と条件を使用するのに対し、プライベートオファーには、交渉された価格、カスタム契約条件、特定の契約期間、および定義された支払いスケジュールを含めることができます。 | BYOC"
type: origin
